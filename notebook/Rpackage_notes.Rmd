...
[**Source**](https://ourcodingclub.github.io/tutorials/writing-r-package/)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage1.png)
...
The above shows the new folder 'SCC_R\_package'. For now, this folder is empty. The first thing that we need to do is to create a new folder inside of 'SCC_R\_package' called 'R'.

![](C:/news/package/SCC_R_package/notebook/images/rpackage2.png)

```{r}
setwd(path)
#create("SCC_R_package")
```
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage3.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage4.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage5.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage6.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage7.png)

The colours you use might vary, but you should see the 'SCC_R\_package' in the upper right indicating the project name.
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage8.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage9.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage10.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage11.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage12.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage13.png)

With the notebook folder now added, I need to initialize a new GitHub repository (see version control notes for help). After doing this for Stirling Coding Club's organisation, here is what it looks like on GitHub.

![](C:/news/package/SCC_R_package/notebook/images/rpackage14.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage15.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage16.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage17.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage18.png)
...
![](C:/news/package/SCC_R_package/notebook/images/rpackage19.png)
...
-   [The minimal R package](The%20minimal%20R%20package)
